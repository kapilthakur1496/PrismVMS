...
@WebServlet(name = "VolunteerEditDetails", urlPatterns = {"/VolunteerEditDetails"})
@MultipartConfig
public class VolunteerEditDetails extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static Connection connection;

    public  VolunteerEditDetails()
    {
    ...
    public void  doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
                ps = connection
                        .prepareStatement("update volunteer_registration set contact_num=? where id='"+volunteerId+"'");
                synchronized (ps) {
            ...
            {
                ps = connection
                        .prepareStatement("update volunteer_registration set photo=? where id='"+volunteerId+"'");
                synchronized (ps) {
