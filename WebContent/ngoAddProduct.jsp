...
<html lang="en">
<head>
<title>Sarvahitkari | Add Product</title>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li><a href="contact.html" class="hyper"><span>Category</span></a></li>	
...
%>  	
<%	String uploadPictue =  request.getParameter("picSection");

	if(uploadPictue == null ) {
	%> 
...
<div class="container" style="paddin:0px; margin-left:0px;">
 ...
 <form id="regForm"  action="NgoControl?action=addProducts" method="post" style=" padding-top:30px;">  
	<div class="container">
	 	<div class="login" > 
	 	 	<div class="main-agileits" style="width: 50%; margin-top:-50px;  margin-left:150px;">
 				<div class="tab">
						 <div class="key">
							...
							<input  type="text"    name="productName" required=""  placeholder="Prodcut Name">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-money" aria-hidden="true"></i>
							<input  type="text"   name="productPrice" required="" placeholder="Product Price">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-sort-numeric-asc" aria-hidden="true"></i>
							<input  type="text" name="totalQty" required="" placeholder="Total Quantity of Products">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-group" aria-hidden="true"></i>
							<input  type="text" name="manufacturerCredit" required="" placeholder="Manufacturing Credit">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-comment" aria-hidden="true"></i>
							<textarea   required="" name="productDescription"   placeholder="Product Description"></textarea>          
							<div class="clearfix"></div>
						</div>
					</div>
					<div class="tab">
				  		<h3 style="margin-bottom:10px; color:#66bdd7;">Add Products</h3> 
						<div class="key">
							<i class="fa fa-group" aria-hidden="true"></i>
							<select name="subCategory" >
								 <% 	 
								 SubCategoryRs = ct.viewSubCategory();
	              				%>
	              				<option>Select Category of Product</option>
	              				<% while(SubCategoryRs.next() ){ %>
	              					<option value="<%=SubCategoryRs.getString("id") %>"> <%= SubCategoryRs.getString("name")%></option>
	              				<%} %> 
							</select>
							<div class="clearfix"></div>
						</div>  
		...
		<%  
		} else if(uploadPictue.equals("1")) {
	 	pId = request.getParameter("pId");
		%><%-- 
		action="NgoControl?action=productPicture&productImage=image1&id="<%=pId%>  --%>
			<div class="main-agileits" style="width: 45%; margin-top: 63px; margin-bottom: 12px; padding: 30px 28px;">
	
		<h3>Add Product Picture 1</h3>
		<br><form id="uploadPicture" enctype="multipart/form-data" action="UploadProductPicture?productImage=image1&id=<%=pId%>" method="post">
		...
		<%  }  else if(uploadPictue.equals("2")) {
	 	pId = request.getParameter("pId");
		%><%-- 
		action="NgoControl?action=productPicture&productImage=image2&id="<%=pId%>  --%>
		
		<div class="main-agileits" style="width: 45%; margin-top: 63px; margin-bottom: 12px; padding: 30px 28px;">
	<h3>Add Product Picture 2</h3>
		<br><form id="uploadPicture" enctype="multipart/form-data" action="UploadProductPicture?productImage=image2&id=<%=pId%>" method="post">
		  	<input required style="width:50%;" type="file" name="file" id="imgInp1" > 
		...
		<%  }  else if(uploadPictue.equals("3")) {
	 	pId = request.getParameter("pId");
		%><%-- 
		action="NgoControl?action=productPicture&productImage=image2&id="<%=pId%>  --%>
			<div class="main-agileits" style="width: 45%; margin-top: 63px; margin-bottom: 12px; padding: 30px 28px;">
			<h3>Add Product Picture 3</h3>
			<br>
			<form id="uploadPicture" enctype="multipart/form-data" action="UploadProductPicture?productImage=image3&id=<%=pId%>" method="post">
			  	<input required style="width:50%;" type="file" name="file" id="imgInp1" > 
			   	<img id="productimage1" src="#"  style="width:100px; height:100px;" />
			   	<br>  <br>  
