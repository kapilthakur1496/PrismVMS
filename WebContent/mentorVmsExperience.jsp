            ...
            <div class="bootstrap-vertical-nav" >
                ...
                <div   id="collapseExample" style="margin-top:3px;" >
                    ...
                    <ul class="nav flex-column" id="exCollapsingNavbar3">
                        ...
                        <li   class="nav-item">
                            <a class="nav-link active" href="mentorVmsExperience.jsp">VMS Feedback</a>
                        </li>
                        <li   class="nav-item">
...
<div class="footer" style="background-color:#2A3F54;   height:50px;">
 ...
 }else if(action!=null)
 {
  ...
  %>
  <%if(action.equals("SubmitExperienced")){ 
 %>
	 <script>
 
    var x = document.getElementById("snackbar")
    x.className = "show";
    x.innerHTML="You Have Send Your Experience Successfully";
