...
<div class="outercontainer" style="padding-top:0px;  padding-right:10px; margin-left:10px; margin-top:10px; margin-right:15px;">
    <div class="row">
            ...
            <div class="bootstrap-vertical-nav" >
                ...
                <div   id="collapseExample" style="margin-top:3px;" >
                    ...
                    <ul class="nav flex-column" id="exCollapsingNavbar3">
                        ...
                        <li   class="nav-item">
                            <a class="nav-link active" href="branchProject.jsp">Branch Projects</a>
                        </li>
                        <li   class="nav-item">
        ...
        <div  class="col-md-10 col-lg-9 col-sm-9 col-xs-12" style="padding:3px 0px;">
 			<form action="Control?action=createBranchProject" method="post" >
		 			
					<br><br><label>Project Title</label><input type="text" name="projectTitle" style="opacity:1" required placeholder="Enter Project Title" class="form-control">
